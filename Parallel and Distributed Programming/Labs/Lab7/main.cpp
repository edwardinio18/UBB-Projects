...
int main(int argc, char *argv[]) {
    ...
    if (world_rank == 0) {
        ...
        Polynomial resultKaratsuba = Util::MpiKaratsuba(polyA, polyB, 0, sizeA);
        end_time = MPI_Wtime();
        std::cout << "Karatsuba Multiplication Result: " << resultKaratsuba.ToString() << std::endl;
