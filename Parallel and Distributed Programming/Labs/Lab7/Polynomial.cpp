...
Polynomial Polynomial::GetCoefficientsInRange(int start, int end) const {
    std::vector<int> resultCoefficients(Coefficients.begin() + start, Coefficients.begin() + end);

    return Polynomial{end - start, resultCoefficients};
}