...
class Scanner:
    ...
    def read_tokens(self):
        token_file_path = os.path.join(os.getcwd(), 'lang', 'token.in')
        try:
            ...
            print("Error: 'token.in' file not found in the 'lang' directory")
    ...
    def scan(self, program_file_name, output_folder):
        try:
            with open(os.path.join("lang", program_file_name), "r") as file:
