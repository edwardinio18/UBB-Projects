...
-- Insert type queries
INSERT INTO Types (tName, tPriceRange) VALUES ('Bronze', '$4.99-$9.99');
INSERT INTO Types (tName, tPriceRange) VALUES ('Silver', '$9.99-$19.99');
INSERT INTO Types (tName, tPriceRange) VALUES ('Gold', '$19.99-$39.99');
INSERT INTO Types (tName, tPriceRange) VALUES ('Platinum', '$39.99-$69.99');
INSERT INTO Types (tName, tPriceRange) VALUES ('Diamond', '$69.99-$99.99');
...
INSERT INTO WorksIn (eID, sID) VALUES (6, 2);
INSERT INTO WorksIn (eID, sID) VALUES (7, 3);
...
EXCEPT
SELECT c1.cFirstName, c1.cLastName FROM Orders o1, Customers c1 WHERE c1.cID = o1.sID AND o1.sID = 3;
...
-- 1.
SELECT c.cFirstName, c.cLastName, s.sName, s.sLoc FROM Stores s
INNER JOIN Orders o ON s.sID = o.sID
INNER JOIN Customers c ON o.cID = c.cID
WHERE s.sName IN ('Downtown', 'Riverside') AND o.oPrice > 50;

-- 2.
SELECT e.eFirstName, e.eLastName FROM Employees e
LEFT JOIN WorksIn wi ON e.eID = wi.eID WHERE e.eLastName LIKE '%h%';

-- 3.
SELECT p.pName, p.pPrice, t.tName FROM Orders o
RIGHT JOIN Products p ON o.pID = p.pID
INNER JOIN Types t ON p.tID = t.tID
WHERE p.pStock > 40;

-- 4.
SELECT DISTINCT c.cFirstName, c.cLastName, d.dAmount, d.dValidUntil, p.pName FROM Customers c
...
FULL JOIN Types t ON t.tID = p.tID;
...
-- 1.
SELECT c.cFirstName, c.cLastName, COUNT(o.oID) AS NumberOfOrders FROM Customers c
...
-- 3.
SELECT TOP 3 c.cFirstName, c.cLastName, d.dAmount, d.dValidUntil FROM Customers c
...
-- 1.
SELECT c.cFirstName, c.cLastName, o.oPrice, o.oDate FROM Orders o
INNER JOIN Customers c on o.cID = c.cID
WHERE o.oDate = ANY
...
-- 2.
SELECT p.pName, p.pPrice FROM Products p
WHERE p.pPrice = ANY
