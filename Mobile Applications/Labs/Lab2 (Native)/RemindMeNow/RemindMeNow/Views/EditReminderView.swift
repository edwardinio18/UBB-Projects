...
struct EditReminderView: View {
	...
	func saveButtonPressed() {
		do {
			try self.reminderListViewModel.updateReminder(id: self.reminder.id, title: titleTextField, date: dateDateField, time: timeDateField, category: categoryEnumField.rawValue, priority: priorityEnumField.rawValue, note: noteTextField)
			presentationMode.wrappedValue.dismiss()
